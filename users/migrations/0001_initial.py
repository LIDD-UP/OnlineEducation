    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nich_name', models.CharField(default='', max_length=50, verbose_name='昵称')),
                ('gender', models.CharField(blank=True, choices=[('male', '男'), ('female', '女')], default='male', max_length=5, verbose_name='性别')),
